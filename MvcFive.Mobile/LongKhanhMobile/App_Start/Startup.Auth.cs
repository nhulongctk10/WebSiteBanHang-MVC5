    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "1605773939640203",
               appSecret: "caca50a2457ca5eb296476a0dd59369f");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "699369889095-5ukervoufpkfbq88degncc4au90cltfg.apps.googleusercontent.com",
                ClientSecret = "IveTH1bPTtEGmGZslVb35Hav"
            });
        }
    }
}